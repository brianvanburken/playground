...
import Json.Decode exposing (Decoder, fail, oneOf, field, int, map, list)
...
decoder =
    field "number" badIntList


badIntList : Decoder (List Int)
badIntList =
    oneOf [ list int, map List.singleton int ]
