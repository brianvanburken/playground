...
`);
  ...
  var serializeForm = (form, metadata, onlyNames = []) => {
    const _a = metadata, { submitter } = _a, meta2 = __objRest(_a, ["submitter"]);
    let injectedElement;
  ...
  var View = class _View {
    ...
    pushEvent(type, el, targetCtx, phxEvent, meta2, opts = {}, onReply) {
      this.pushWithReply(() => this.putRef([{ el, loading: true, lock: true }], phxEvent, type, opts), "event", {
        type,
        event: phxEvent,
        value: this.extractMeta(el, meta2, opts.value),
    ...
    pushInput(inputEl, targetCtx, forceCid, phxEvent, opts, callback) {
      ...
      let formData;
      let meta2 = this.extractMeta(inputEl.form);
      if (inputEl instanceof HTMLButtonElement) {
        meta2.submitter = inputEl;
      }
      if (inputEl.getAttribute(this.binding("change"))) {
        formData = serializeForm(inputEl.form, __spreadValues({ _target: opts._target }, meta2), [inputEl.name]);
      } else {
        formData = serializeForm(inputEl.form, __spreadValues({ _target: opts._target }, meta2));
      }
    ...
    pushFormSubmit(formEl, targetCtx, phxEvent, submitter, opts, onReply) {
      ...
      if (LiveUploader.hasUploadsInProgress(formEl)) {
        ...
        this.uploadFiles(formEl, phxEvent, targetCtx, ref, cid, (_uploads) => {
          ...
          let meta2 = this.extractMeta(formEl);
          let formData = serializeForm(formEl, __spreadValues({ submitter }, meta2));
  ...
  // node_modules/@dicebear/shapes/lib/index.js
  var lib_exports = {};
  ...
  // node_modules/@dicebear/shapes/lib/components/index.js
  ...
  // node_modules/@dicebear/shapes/lib/components/shape1.js
  var shape1 = {
    "rectangle": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M90 10H10v80h80V10ZM0 0v100h100V0H0Z" fill="${escape_exports.xml(`${colors.shape1}`)}"/>`,
    "rectangleFilled": (components, colors) => `<path d="M0 0h100v100H0V0Z" fill="${escape_exports.xml(`${colors.shape1}`)}"/>`,
    "ellipseFilled": (components, colors) => `<path d="M100 50A50 50 0 1 1 0 50a50 50 0 0 1 100 0Z" fill="${escape_exports.xml(`${colors.shape1}`)}"/>`,
    "ellipse": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M50 90a40 40 0 1 0 0-80 40 40 0 0 0 0 80Zm0 10A50 50 0 1 0 50 0a50 50 0 0 0 0 100Z" fill="${escape_exports.xml(`${colors.shape1}`)}"/>`,
    "polygonFilled": (components, colors) => `<path d="m50 7 50 86.6H0L50 7Z" fill="${escape_exports.xml(`${colors.shape1}`)}"/>`,
    "polygon": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M50 7 0 93.6h100L50 7Zm0 20L17.3 83.6h65.4L50 27Z" fill="${escape_exports.xml(`${colors.shape1}`)}"/>`,
    "line": (components, colors) => `<path fill="${escape_exports.xml(`${colors.shape1}`)}" d="M45-150h10v400H45z"/>`
  };

  // node_modules/@dicebear/shapes/lib/components/shape2.js
  var shape2 = {
    "rectangle": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M90 10H10v80h80V10ZM0 0v100h100V0H0Z" fill="${escape_exports.xml(`${colors.shape2}`)}"/>`,
    "rectangleFilled": (components, colors) => `<path d="M0 0h100v100H0V0Z" fill="${escape_exports.xml(`${colors.shape2}`)}"/>`,
    "ellipseFilled": (components, colors) => `<path d="M100 50A50 50 0 1 1 0 50a50 50 0 0 1 100 0Z" fill="${escape_exports.xml(`${colors.shape2}`)}"/>`,
    "ellipse": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M50 90a40 40 0 1 0 0-80 40 40 0 0 0 0 80Zm0 10A50 50 0 1 0 50 0a50 50 0 0 0 0 100Z" fill="${escape_exports.xml(`${colors.shape2}`)}"/>`,
    "polygonFilled": (components, colors) => `<path d="m50 7 50 86.6H0L50 7Z" fill="${escape_exports.xml(`${colors.shape2}`)}"/>`,
    "polygon": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M50 7 0 93.6h100L50 7Zm0 20L17.3 83.6h65.4L50 27Z" fill="${escape_exports.xml(`${colors.shape2}`)}"/>`,
    "line": (components, colors) => `<path fill="${escape_exports.xml(`${colors.shape2}`)}" d="M45-150h10v400H45z"/>`
  };

  // node_modules/@dicebear/shapes/lib/components/shape3.js
  var shape3 = {
    "rectangle": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M90 10H10v80h80V10ZM0 0v100h100V0H0Z" fill="${escape_exports.xml(`${colors.shape3}`)}"/>`,
    "rectangleFilled": (components, colors) => `<path d="M0 0h100v100H0V0Z" fill="${escape_exports.xml(`${colors.shape3}`)}"/>`,
    "ellipseFilled": (components, colors) => `<path d="M100 50A50 50 0 1 1 0 50a50 50 0 0 1 100 0Z" fill="${escape_exports.xml(`${colors.shape3}`)}"/>`,
    "ellipse": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M50 90a40 40 0 1 0 0-80 40 40 0 0 0 0 80Zm0 10A50 50 0 1 0 50 0a50 50 0 0 0 0 100Z" fill="${escape_exports.xml(`${colors.shape3}`)}"/>`,
    "polygonFilled": (components, colors) => `<path d="m50 7 50 86.6H0L50 7Z" fill="${escape_exports.xml(`${colors.shape3}`)}"/>`,
    "polygon": (components, colors) => `<path fill-rule="evenodd" clip-rule="evenodd" d="M50 7 0 93.6h100L50 7Zm0 20L17.3 83.6h65.4L50 27Z" fill="${escape_exports.xml(`${colors.shape3}`)}"/>`,
    "line": (components, colors) => `<path fill="${escape_exports.xml(`${colors.shape3}`)}" d="M45-150h10v400H45z"/>`
  };

  // node_modules/@dicebear/shapes/lib/utils/pickComponent.js
  ...
  // node_modules/@dicebear/shapes/lib/utils/getComponents.js
  ...
  // node_modules/@dicebear/shapes/lib/utils/convertColor.js
  function convertColor2(color) {
    return "transparent" === color ? color : `#${color}`;
  }

  // node_modules/@dicebear/shapes/lib/utils/getColors.js
  function getColors({ prng, options }) {
    var _a, _b, _c;
    return {
      "shape1": convertColor2(prng.pick((_a = options.shape1Color) !== null && _a !== void 0 ? _a : [], "transparent")),
      "shape2": convertColor2(prng.pick((_b = options.shape2Color) !== null && _b !== void 0 ? _b : [], "transparent")),
      "shape3": convertColor2(prng.pick((_c = options.shape3Color) !== null && _c !== void 0 ? _c : [], "transparent"))
    };
  }

  // node_modules/@dicebear/shapes/lib/hooks/onPreCreate.js
  ...
  // node_modules/@dicebear/shapes/lib/schema.js
  var schema2 = {
    "$schema": "http://json-schema.org/draft-07/schema#",
    "properties": {
      "backgroundColor": {
  ...
  var create2 = ({ prng, options }) => {
    ...
    return {
      ...
      extra: () => __spreadValues(__spreadValues({}, Object.entries(components).reduce((acc, [key, value]) => {
  ...
  avatar = function(seed) {
    const avatar2 = createAvatar(lib_exports, {
      seed
    });
    return avatar2.toString();
  };
