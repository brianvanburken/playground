import Config
config :task_manager, token_signing_secret: "gT78Xbgiru6lyj4nbYJRkU0Ne3w95cSh"
...
config :task_manager, TaskManagerWeb.Endpoint,
  ...
  secret_key_base: "XBb4KaYkTqCQ8BaS8Es5kZlDcysR4EX5whKKwFgKsQhhiWRxnIg9odZrT4FGwJ93",
  server: false
