        ...
        <div>
            <div className="welcome">
                ...
                <p>
                    ...
                    from Manning Publications. This app is the example
                    application that you'll build as you go through the book. In
                    React in Action, you'll learn:
                </p>
                <ul>
                    <li>Building a simple social app</li>
                    <li>Learning about the fundamentals of React</li>
                    <li>
                        Building React apps with modern JavaScript (ES2015 and
                        beyond)
                    </li>
                    <li>
                        How React works (React in action covers through React 16
                        (fiber))
                    </li>
